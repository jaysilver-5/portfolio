...
const Nav = () => {
  return (
    <nav className='mt-16 fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50'>
      <div class='container mx-auto'>
        ...
        <Link to='home' activeClass='active' offset={-200} smooth={true} spy={true} className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center">
            <BiHomeAlt />
          </Link>
